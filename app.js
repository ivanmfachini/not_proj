...
app.use(session({
    store: new pgSession({
        conString: `postgres://ivanmfachini:${process.env.PG_PW}@${process.env.HOSTNAME}/${process.env.PG_DB}`
    }),
